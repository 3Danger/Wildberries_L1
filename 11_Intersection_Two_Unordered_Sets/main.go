...
func main() {
	...
	fmt.Println(solutions(arr1, arr2))
}

func solutions(arr1, arr2 []int) []int {
	...
	// в качестве value для map использую заглушку struct{}{}
	...
	for i := 0; i < len(arr2); i++ {
		//Смотрим какие Key у нас уже имеются в map
